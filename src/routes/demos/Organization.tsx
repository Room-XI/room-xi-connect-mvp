...
const features: FeatureSection[] = [
  {
    ...
    description:
      'Monitor youth wellness trends, program engagement, and crisis patterns across your organization. All data is aggregated and privacy-protected.',
    features: [
  ...
  },
  {
    ...
    description:
      'Replace paper sign-in sheets with instant QR code attendance. Youth scan to check in, and you get real-time attendance data.',
    features: [
  ...
  },
  {
    ...
    description:
      'Ximi AI detects crisis keywords and escalates appropriately. Staff can monitor crisis flag patterns (aggregate only) to understand community needs.',
    features: [
  ...
  },
  {
    ...
    description:
      'See aggregate demographics of youth using your programs. Identify underserved populations and equity gaps. Youth self-report their identity privately.',
    features: [
  ...
  },
  {
    ...
    description:
      'Understand community wellness patterns through aggregated mood data. See seasonal trends, impacts of events, and overall community wellbeing.',
    features: [
  ...
  },
  {
    ...
    description:
      'Track which programs youth discover, save, and attend. Understand demand signals for new programming and optimize resource allocation.',
    features: [
  ...
  },
  {
    ...
    description:
      'Full Alberta PIPA/HIA compliance with audit trails, consent management, and breach notification systems. Designed for regulatory peace of mind.',
    features: [
  ...
  },
  {
    ...
    description:
      'Generate reports for funders, city council, and stakeholders. All exports are privacy-protected and formatted for common reporting requirements.',
    features: [
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-deepSage/10 via-teal/5 to-sage/10 py-16 px-6">
        ...
        >
          ...
          <p className="text-xl text-textSecondaryLight max-w-2xl mx-auto">
            Privacy-safe analytics, attendance tracking, and real-time insights for youth-serving
            organizations and city partners.
          </p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-textSecondaryLight text-sm">
                All organization-facing data is <strong>aggregated and anonymized</strong>. You
                never see individual youth data. K-anonymity ensures minimum 7 users per data
                bucket. Differential privacy adds mathematical noise to protect individuals.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-display font-bold text-deepSage">What Organizations Get</h2>
            ...
            >
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-display font-bold text-deepSage text-lg">{feature.title}</h3>
                  <p className="text-sm text-textSecondaryLight">{feature.subtitle}</p>
                </div>
              ...
              {expandedSection === feature.id && (
                ...
                >
                  <p className="text-textSecondaryLight">{feature.description}</p>
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2">
                        {feature.features.map((item, i) => (
                          <li
                            key={i}
                            className="flex items-start gap-2 text-sm text-textSecondaryLight"
                          >
            ...
            <div className="p-4 bg-white rounded-xl border border-teal/20">
              ...
              <ul className="text-sm text-textSecondaryLight space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-teal">•</span>
                  <span>
                    <strong>Zero cost</strong> to the City of Edmonton
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-teal">•</span>
        ...
        >
          <h3 className="text-xl font-display font-bold text-deepSage">Partner With Room XI</h3>
          <p className="text-textSecondaryLight max-w-md mx-auto">
            Ready to bring privacy-first youth wellness tracking to your organization or city
            programs?
          </p>
      ...
      <div className="bg-gradient-to-br from-deepSage/5 via-teal/5 to-cosmic/10 py-12 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            <Link to="/terms-of-service" className="text-teal hover:text-teal/80 transition-colors">
              Terms of Service
            </Link>
            <Link to="/privacy-policy" className="text-teal hover:text-teal/80 transition-colors">
              Privacy Policy
            </Link>
            <Link to="/about" className="text-teal hover:text-teal/80 transition-colors">
              About Us
            </Link>
          </div>
        </div>
