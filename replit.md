...
**Mood Orb Enhancements (Nov 2025):** The 7-day gradient mood orb now features PNG export capabilities via html2canvas, week-over-week comparison showing trend indicators, 30-day historical timelapse browsing, custom date range backend queries, and three accessibility settings (high visibility, pattern overlay, color key) stored in the profiles table.
